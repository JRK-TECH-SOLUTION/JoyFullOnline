        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-sm-12">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <form action="kupdateProfile" method="post" enctype="multipart/form-data">
                            @csrf
        ...
        <div class="row">
            <div class="col-sm-12 col-lg-4">
                <div class="card card-info card-outline">
                    ...
                    <div class="card-body">
                        <form action="kchangePassword" method="post">
                            @csrf
                            <div class="form-group">
                ...
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-8 col-sm-12">
                                <form action="kupdateimage" method="post"  enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
